...
public class InvoiceResponseDTOOldMapper {

    public static InvoiceResponseDTOOld toDTO(Invoice entity) {
        if (entity == null) {
            return null;
        }
        InvoiceResponseDTOOld dto = new InvoiceResponseDTOOld();
    ...
    public static Invoice toEntity(InvoiceResponseDTOOld dto) {
        if (dto == null) {
            return null;
        }
    ...
    public static List<InvoiceResponseDTOOld> toDTOList(List<Invoice> invoices) {
        if (invoices == null) {
            return Collections.emptyList();
        }
        return invoices.stream()
                .map(InvoiceResponseDTOOldMapper::toDTO)
