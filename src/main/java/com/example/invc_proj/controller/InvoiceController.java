...
public class InvoiceController {
    ...
    public ResponseEntity<ApiResponse<Invoice>> updateInvoiceStatus(@PathVariable Long p_invoice_id,
                                       @PathVariable InvoiceStatus p_invoice_status,
                                       @PathVariable BigDecimal p_amount_paid)
    {
    ...
    public ResponseEntity<ApiResponse<String>> deleteInvoice(@PathVariable Long p_invoice_id)
    {
        service.deleteInvoice(p_invoice_id);
        return ApiResponses.ok("Invoice Deleted Successfully");
    }
